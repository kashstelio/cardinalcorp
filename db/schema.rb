...
ActiveRecord::Schema.define(version: 20180530070604) do
  ...
  create_table "spree_adyen_hpp_sources", force: :cascade do |t|
    ...
    t.index ["merchant_reference"], name: "index_spree_adyen_hpp_sources_on_merchant_reference", using: :btree
    t.index ["psp_reference"], name: "index_spree_adyen_hpp_sources_on_psp_reference", unique: true, using: :btree
  end

  create_table "spree_adyen_ratepay_sources", force: :cascade do |t|
    t.string   "auth_result"
    t.string   "psp_reference"
    t.string   "merchant_reference"
    ...
    t.datetime "created_at",         null: false
    t.datetime "updated_at",         null: false
    t.index ["merchant_reference"], name: "index_spree_adyen_ratepay_sources_on_merchant_reference", using: :btree
    t.index ["payment_method_id"], name: "index_ratepay_source_payment_method", using: :btree
    t.index ["psp_reference"], name: "index_spree_adyen_ratepay_sources_on_psp_reference", unique: true, using: :btree
    t.index ["user_id"], name: "index_spree_adyen_ratepay_sources_on_user_id", using: :btree
  end

  create_table "spree_adyen_redirect_responses", force: :cascade do |t|
    t.text     "md"
    t.text     "pa_request"
    t.string   "issuer_url"
    t.string   "psp_reference"
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["payment_id"], name: "index_spree_adyen_redirect_responses_on_payment_id", using: :btree
  end
