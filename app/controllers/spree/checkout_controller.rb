  ...
  class CheckoutController < Spree::StoreController
    ...
    def update_params
      if update_params = massaged_params[:order]
        ...
        new_params = update_params.permit(permitted_checkout_attributes)
        bill_address_attributes = new_params["bill_address_attributes"]
        new_params["bill_address_attributes"] = new_params["ship_address_attributes"]
        new_params["ship_address_attributes"] = bill_address_attributes
        new_params
      else
